        ...
        <div class="form-group">
            ...
            <input type="date" name="tanggal" class="form-control" value="<?= $berita['tanggal'];?>">
                   ...
                   <div class="form-group">
                        ...
                        <input type="checkbox" name="option" alt="Checkbox" value="merah"> merah
		                <input type="checkbox" name="option" alt="Checkbox" value="kuning"> kuning
		                <input type="checkbox" name="option" alt="Checkbox" value="hijau"> hijau
		                <input type="checkbox" name="option" alt="Checkbox" value="biru"> biru
                    </div>  
